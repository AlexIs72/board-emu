...
#include <memory/segment/iterator.h>
    ...
    namespace core {
		class memory_segment {
	    	...
	    	public:
				...
				typedef memory_segment_iterator<uint8_t>  byte_iterator;
                typedef memory_segment_iterator<uint16_t> word_iterator;
                typedef memory_segment_iterator<uint32_t> dword_iterator;
